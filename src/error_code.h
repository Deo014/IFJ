...
typedef enum error_code{
    ...
    ERROR_CODE_SEM = 4,    // semanticka chyba typové kompatibility v aritmetických, řetězcových a relačních výrazech, příp. špatný počet či typ parametrů u volání funkce
